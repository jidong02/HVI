...
def load_datasets():
    ...
    if opt.dataset == 'lol_v1':
        ...
        test_set = get_SICE_eval_set(opt.data_val_euvp)
    elif opt.dataset == 'lsui':
        train_set = get_euvp_training_set(opt.data_train_lsui, size=opt.cropSize)
        test_set = get_SICE_eval_set(opt.data_val_lsui)
    else:
...
if __name__ == '__main__':
    ...
    print(f'  Epochs:     {opt.nEpochs}')
    print(f'  Pretrain:   {opt.pretrain}')
    print(f'  Seed:       3407')
    print(f'==================')
